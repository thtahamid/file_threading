...
categories = {
    "Programming": [
        "programming", "code", "software", "developer", "python", "java", "c++", "c ","bash","unity", "javascript", "software engineering"
    ],
    "AI": [
    ...
    "Math": [
        "mathematics", "math", "algebra", "calculus", "statistics","linearalgebra","linear", "probability", "geometry", "discrete math"
    ],
    "Database": [
        "database", "SQL", "NoSQL", "data management", "data storage", "database design", "big data"
    ],
    "Security": [
        "cryptography", "security", "networksecurity", "cybersecurity", "encryption", "malware", "phishing",
